...
import { REACT_CONCURRENT_MODE_TYPE, REACT_FRAGMENT_TYPE, REACT_PROFILER_TYPE, REACT_STRICT_MODE_TYPE, REACT_SUSPENSE_TYPE } from "./react-shared/ReactSymbols.js";
...
const React = {
  ...
  createElement:
  /* __DEV__ */
  false ? createElementWithValidation : createElement,
  cloneElement:
  /* __DEV__ */
  false ? cloneElementWithValidation : cloneElement,
  createFactory:
  /* __DEV__ */
  false ? createFactoryWithValidation : createFactory,
