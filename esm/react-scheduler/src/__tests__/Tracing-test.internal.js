...
describe('Tracing', () => {
  ...
  describe('enableSchedulerTracing enabled', () => {
    ...
    it('should return the value of a traced function', () => {
      expect(SchedulerTracing.unstable_trace('arbitrary', currentTime, () => 123)).toBe(123);
    });
    ...
    it('should support nested traced events', done => {
      ...
      SchedulerTracing.unstable_trace('outer event', currentTime, () => {
        ...
        advanceTimeBy(50);
        const wrapperOuterIndirection = SchedulerTracing.unstable_wrap(outerIndirection);
        let wrapperInnerIndirection;
        let innerEventTraced = false; // Verify that a nested event is properly traced
        ...
        expect(innerEventTraced).toBe(true); // Verify that the original event is restored
    ...
    describe('advanced integration', () => {
      it('should return a unique threadID per request', () => {
        expect(SchedulerTracing.unstable_getThreadID()).not.toBe(SchedulerTracing.unstable_getThreadID());
      });
