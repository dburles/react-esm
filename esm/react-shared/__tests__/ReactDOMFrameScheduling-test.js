...
describe('ReactDOMFrameScheduling', () => {
  it('warns when requestAnimationFrame is not polyfilled in the browser', () => {
    ...
    try {
      ...
      expect(console.error.calls.argsFor(0)[0]).toMatch("This browser doesn't support requestAnimationFrame.");
    } finally {
  ...
  it('can import findDOMNode in Node environment', () => {
    ...
    try {
      ...
      global.requestIdleCallback = undefined; // Simulate the Node environment:
